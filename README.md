...
curl -OL https://raw.githubusercontent.com/haqq-network/mainnet/mainnet-seed/genesis.json && \
mv genesis.json $HOME/.haqqd/config/genesis.json

# Configure State sync
curl -OL https://raw.githubusercontent.com/haqq-network/mainnet/mainnet-seed/state_sync.sh && \
sh state_sync.sh
